...
{"src/apps/*", [encrypt_debug_info, {d, debug}, {outdir, "ebin"}, {i, "include"}, {i, ".."}]}.
{"src/media/ems_media.erl", [encrypt_debug_info, {outdir, "ebin"}, {i, "include"}, {i, ".."}]}.
{"src/media/*", [encrypt_debug_info, {outdir, "ebin"}, {i, "include"}, {i, ".."}]}.
{"src/auth/*", [encrypt_debug_info, {d, debug}, {outdir, "ebin"}, {i, "include"}, {i, ".."}]}.
{"src/demos/*", [encrypt_debug_info, {d, debug}, {outdir, "ebin"}, {i, "include"}, {i, ".."}]}.
{"src/formats/*", [encrypt_debug_info, {d, debug}, {outdir, "ebin"}, {i, "include"}, {i, ".."}]}.
{"src/protocols/*", [encrypt_debug_info, {d, debug}, {outdir, "ebin"}, {i, "include"}, {i, ".."}]}.
...
{"deps/mpegts/src/*", [encrypt_debug_info, {outdir, "deps/mpegts/ebin"}, {i, "deps/mpegts/src"}, {i, "deps"}]}.
