 ...
 [
  ...
  {env, [
		...
		{vhosts, [
		   ...
		   {videomail, [
		      {hostname, ["videomail.local"]},
		      {applications, [vkontakte, apps_push, apps_streaming, apps_recording, apps_rtmp, apps_shared_objects]},
					{auth_module, vkontakte},
					{access_log, {"log", "video-access", {size, 1000000}, 10, "log", info}},
					{error_log, {"log", "video-error", {size, 1000000}, 10, "log", info}},
