...
decode_remaining_test() -> ?assertEqual({undefined,<<16#01>>},
                                            amf3:decode(<<16#00,16#01>>)).

decode_undefined_test() -> ?assertEqual({undefined,<<>>},
                                        amf3:decode(<<16#00>>)).
                                        
decode_null_test() -> ?assertEqual({null,<<>>},
                                   amf3:decode(<<16#01>>)).
                                   
decode_false_test() -> ?assertEqual({false,<<>>},
                                    amf3:decode(<<16#02>>)).
                                    
decode_true_test() -> ?assertEqual({true,<<>>},
                                   amf3:decode(<<16#03>>)).
...
decode_integer_test_() ->
  [     
    ?_assertEqual({-268435456,<<>>},
                  amf3:decode(<<16#04,16#C0,16#80,16#80,16#00>>)),
    
    ?_assertEqual({-10,<<>>},
                  amf3:decode(<<16#04,16#FF,16#FF,16#FF,16#F6>>)), 
    
    ?_assertEqual({-1,<<>>},
                  amf3:decode(<<16#04,16#FF,16#FF,16#FF,16#FF>>)),
    
    ?_assertEqual({0,<<>>},
                  amf3:decode(<<16#04,16#00>>)),  
                  
    ?_assertEqual({127,<<>>},
                  amf3:decode(<<16#04,16#7F>>)),
   
    ?_assertEqual({128,<<>>},
                  amf3:decode(<<16#04,16#81,16#00>>)),
                  
    ?_assertEqual({16383,<<>>},
                  amf3:decode(<<16#04,16#FF,16#7F>>)),
    
    ?_assertEqual({16384,<<>>},
                  amf3:decode(<<16#04,16#81,16#80,16#00>>)),
                  
    ?_assertEqual({2097151,<<>>},
                  amf3:decode(<<16#04,16#FF,16#FF,16#7F>>)),
                  
    ?_assertEqual({2097152,<<>>},
                  amf3:decode(<<16#04,16#80,16#C0,16#80,16#00>>)),
                  
    ?_assertEqual({268435455,<<>>},
                  amf3:decode(<<16#04,16#BF,16#FF,16#FF,16#FF>>))
  ].    
...
decode_double_test_() ->
  [ 
    ?_assertEqual({268435456.0,<<>>},
                  amf3:decode(<<16#05,16#41,16#B0,16#00,16#00,16#00,16#00,
                                16#00,16#00>>)),
                                           
    ?_assertEqual({268435456.5,<<>>}, 
                  amf3:decode(<<16#05,16#41,16#B0,16#00,16#00,16#00,16#80,
                                16#00,16#00>>)),
                                           
    ?_assertEqual({10.1,<<>>},
                  amf3:decode(<<16#05,16#40,16#24,16#33,16#33,16#33,16#33,
                                16#33,16#33>>)),
                                    
    ?_assertEqual({-268435457.0,<<>>},
                  amf3:decode(<<16#05,16#C1,16#B0,16#00,16#00,16#01,16#00,
                                16#00,16#00>>)),
                                            
    ?_assertEqual({-72057594037927940.0,<<>>},
                  amf3:decode(<<16#05,16#C3,16#70,16#00,16#00,16#00,16#00,
                                16#00,16#00>>)),
                                                    
    ?_assertEqual({72057594037927940.0,<<>>},
                  amf3:decode(<<16#05,16#43,16#70,16#00,16#00,16#00,16#00,
                                16#00,16#00>>)),
                                                   
    ?_assertEqual({1.79e308,<<>>},
                  amf3:decode(<<16#05,16#7F,16#EF,16#DC,16#F1,16#58,16#AD,
                                16#BB,16#99>>)),
                                        
    ?_assertEqual({-1.79e308,<<>>},
                  amf3:decode(<<16#05,16#FF,16#EF,16#DC,16#F1,16#58,16#AD,
                                16#BB,16#99>>)),
                                         
    ?_assertEqual({infinity,<<>>},
                  amf3:decode(<<16#05,16#7F,16#F0,16#00,16#00,16#00,16#00,
                                16#00,16#00>>)),
                                        
    ?_assertEqual({'-infinity',<<>>},
                  amf3:decode(<<16#05,16#FF,16#F0,16#00,16#00,16#00,16#00,
                                16#00,16#00>>)),
                                           
    ?_assertEqual({nan,<<>>},
                  amf3:decode(<<16#05,16#FF,16#F8,16#00,16#00,16#00,16#00,
                                16#00,16#00>>))
  ].  
...
decode_string_test_() ->
  [
    ?_assertEqual({<<"">>,<<>>},
                  amf3:decode(<<16#06,16#01>>)),
   
    ?_assertEqual({<<"hello">>,<<>>}, 
                  amf3:decode(<<16#06,16#0B,16#68,16#65,16#6C,16#6C,16#6F>>)),

    ?_assertEqual({<<"hello world">>,<<>>}, 
                  amf3:decode(<<16#06,16#17,16#68,16#65,16#6C,16#6C,16#6F,
                                16#20,16#77,16#6F,16#72,16#6C,16#64>>)),
...
decode_xmldoc_test_() ->
  [
    ?_assertEqual({{xmldoc,<<"<text>hello</text>">>},<<>>}, 
                  amf3:decode(<<16#07,16#25,16#3C,16#74,16#65,16#78,16#74,
                                16#3E,16#68,16#65,16#6C,16#6C,16#6F,16#3C,
                                16#2F,16#74,16#65,16#78,16#74,16#3E>>)),
...
decode_date_test_() -> 
  [
    ?_assertEqual({{date,1260103478896.0},<<>>},
                  amf3:decode(<<16#08,16#01,16#42,16#72,16#56,16#40,
                                16#52,16#E7,16#00,16#00>>)),

    %% date reference
    ?_assertEqual({{object,
                    <<>>,
                    dict:store(b,
                               {date,1261385577404.0},
                               dict:store(a,
                                          {date,1261385577404.0},
                                          dict:new()))},
                   <<>>}, 
                  amf3:decode(<<16#0A,16#0B,16#01,16#03,16#61,16#08,16#01,
                                16#42,16#72,16#5B,16#07,16#07,16#3B,16#C0,
...
decode_array_test_() ->
  [
    %% dense only
    ?_assertEqual({[100],<<>>}, 
                  amf3:decode(<<16#09,16#03,16#01,16#04,16#64>>)),
    
    ?_assertEqual({[100,200],<<>>},
                  amf3:decode(<<16#09,16#05,16#01,16#04,16#64,16#04,
                                16#81,16#48>>)),
    
    ?_assertEqual({[100,200],<<16#01,16#01>>},
                  amf3:decode(<<16#09,16#05,16#01,16#04,16#64,16#04,
                                16#81,16#48,16#01,16#01>>)),
                                                     
    %% associative only
    ?_assertEqual({[{a,100},{b,200}],<<>>},
                   amf3:decode(<<16#09,16#01,16#03,16#61,16#04,16#64,
                                 16#03,16#62,16#04,16#81,16#48,16#01>>)),                                                 

    %% mixed  
    ?_assertEqual({[{a,100},{b,200},500,600],<<>>},
                   amf3:decode(<<16#09,16#05,16#03,16#61,16#04,16#64,
                                 16#03,16#62,16#04,16#81,16#48,16#01,
    ...
    ?_assertEqual({{object,
                    ...
                    dict:store(b,
                               ...
                               dict:store(a, 
                                          ...
                                          dict:new()))},
                   <<>>},
                  amf3:decode(<<16#0A,16#0B,16#01,16#03,16#61,16#04,16#64,
                                16#03,16#62,16#04,16#81,16#48,16#01>>)),
      ...
      ?_assertEqual({{object,
                      ...
                      dict:store(b,
                                 ...
                                 dict:store(a,
                                            ...
                                            dict:new()))},
                     <<>>}, 
                    amf3:decode(<<16#0A,16#0B,16#01,16#03,16#61,16#0A,16#01,
                                  16#01,16#03,16#62,16#0A,16#02,16#01>>)),
       ...
       ?_assertEqual({{object,
                      ...
                      dict:store(a,
                                 {object,
                                  ...
                                  dict:new())},
                      <<>>}, 
                     amf3:decode(<<16#0A,16#0B,16#01,16#03,16#61,16#0A,16#23,
                                   16#13,16#54,16#65,16#73,16#74,16#43,16#6C,
                                   16#61,16#73,16#73,16#05,16#6E,16#31,16#05,
                                   16#6E,16#32,16#01,16#01,16#01>>)),
...
decode_bytearray_test_() -> 
  [
    ?_assertEqual({{bytearray,<<100,200>>},<<>>},
                  amf3:decode(<<16#0C,16#05,100,200>>)),
    ...
    ?_assertEqual({{object,
                   ...
                   dict:store(b, 
                              ...
                              dict:store(a,
                                         ...
                                         dict:new()))},
                   <<>>},
                  amf3:decode(<<16#0A,16#0B,16#01,16#03,16#61,16#0C,
                                16#05,16#64,16#C8,16#03,16#62,16#0C,
                                16#02,16#01>>))
...
encode_array_test_() ->
  [
    %% dense only
    ?_assertEqual(<<16#09,16#03,16#01,16#04,16#64>>,amf3:encode([100])),
    
    ?_assertEqual(<<16#09,16#05,16#01,16#04,
               16#64,16#04,16#81,16#48>>, amf3:encode([100,200])),
    
    ?_assertEqual(<<16#09,16#07,16#01,16#01,16#09,16#05,16#01,16#04,
                    16#64,16#04,16#81,16#48,16#02>>,
                amf3:encode([null,[100,200],false])),  
               
    
    %% associative only           
    ?_assertEqual(<<16#09,16#01,16#03,16#61,16#04,16#64,
                     16#03,16#62,16#04,16#81,16#48,16#01>>, 
                   amf3:encode([{a,100},{b,200}])),
                                                     
    %% mixed  
    ?_assertEqual(<<16#09,16#05,16#03,16#61,16#04,16#64,
               16#03,16#62,16#04,16#81,16#48,16#01,
               16#04,16#83,16#74,16#04,16#84,16#58>>, 
               amf3:encode([{a,100},{b,200},500,600]))                                               
  ].
